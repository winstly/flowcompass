---
name: pm-requirements-initial-review
description: >
...
level: 1
pipeline: [pm-structural-decomposition, pm-requirements-initial-review, pm-requirements-alignment]
handoff-policy: auto
...
<Do_Not_Use_When>
- 需求已经过深度分析和确认（用 pm-requirements-alignment）
- 正在做技术方案设计（用 pm-execution-planning）
- 正在划定业务范围与In/Out Scope（用 pm-requirements-alignment）
</Do_Not_Use_When>
...
```json
{
  "skill": "pm-requirements-initial-review",
  "status": "completed",
  "complexity": "STANDARD",
  "output": "wiki/summaries/requirements/summary.md",
  "confidence": "HIGH",
  "next": "pm-requirements-alignment"
}
```
...
```markdown
## [TIMESTAMP] pm-requirements-initial-review | {level} level
