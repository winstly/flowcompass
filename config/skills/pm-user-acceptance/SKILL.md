...
level: 3
pipeline: [pm-qa-closure-documentation, pm-user-acceptance, pm-project-closure-iteration]
...
<Do_Not_Use_When>
- 准出报告尚未完成（用 pm-qa-closure-documentation）
- 用户已签署验收（用 pm-project-closure-iteration）
- 只需要内部测试不需要用户参与
</Do_Not_Use_When>
...
```markdown
## [TIMESTAMP] pm-user-acceptance | {level} level
