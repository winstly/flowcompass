...
level: 3
pipeline: [pm-visual-verification, pm-dual-qa-review, pm-qa-closure-documentation]
handoff-policy: auto
...
<Do_Not_Use_When>
- 自检尚未通过（用 pm-internal-self-check）
- 质检已完成需要闭环（用 pm-qa-closure-documentation）
...
```markdown
## [TIMESTAMP] pm-dual-qa-review | {level} level
