---
name: pm-project-closure-iteration
description: >
...
level: 3
pipeline: [pm-user-acceptance, pm-project-closure-iteration, pm-structural-decomposition]
handoff-policy: auto
...
<Do_Not_Use_When>
- 用户验收尚未完成（用 pm-user-acceptance）
- 项目尚未启动（用 pm-structural-decomposition）
- 只需要查看项目资料不需要归档
</Do_Not_Use_When>
...
```markdown
## [TIMESTAMP] pm-project-closure-iteration | {level} level
