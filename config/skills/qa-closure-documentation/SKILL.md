...
level: 3
pipeline: [dual-qa-review, qa-closure-documentation, user-acceptance]
handoff-policy: auto
...
<Do_Not_Use_When>
- QA质检尚未完成（用 dual-qa-review）
- 准出报告已签署（用 user-acceptance）
- 只需要查看QA结果不需要处理
</Do_Not_Use_When>
...
```markdown
## [TIMESTAMP] qa-closure-documentation | {level} level
